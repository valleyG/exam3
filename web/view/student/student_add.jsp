        ...
        <form action="student/addStudent" method="post" class="form-horizontal">
            <div class="form-group">
                <div class="col-xs-5 ">
                    ...
                    <div class="col-xs-8 "><input type="text" class="form-control" name="sName" id="sName" placeholder="请输入学生名字"> </div>
                </div>
                    ...
                    <div class="col-xs-8 ">
                        <select name="cId" id="cId" class="form-control">
                            <c:forEach items="${grades}" var="grade">
                                <option value="${grade.cId}">${grade.cName}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-5 col-xs-offset-1">
                    ...
                    <div class="col-xs-8">
                        <input type="text" id="sAge" name="sAge" class="form-control" placeholder="请输入学生年龄">
                    </div>
                </div>
            </div>
            <div class="form-group col-xs-8 col-xs-offset-4">
                <button type="submit" class="btn btn-success col-xs-offset-10" style="width: 100px;"><span class="glyphicon glyphicon-plus"></span> 添加</button>
            </div>
